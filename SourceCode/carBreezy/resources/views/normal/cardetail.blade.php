...
@section('main')
    ...
    <div class="row mb-5 mt-2 bg-light">
        ...
        <div class="ml-5 col-4">
            ...
            <a @if ($concact==1)href="{{route('Client.Order')}}"
            @else href="{{route("auth.ask")}}"@endif class="text-light"><button class="btn btn-block btn-dark col-3"><i class="fas fa-shopping-cart"></i></button></a>
