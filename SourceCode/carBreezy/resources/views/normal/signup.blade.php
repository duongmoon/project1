            ...
            <div class="card-body">
                <div class="m-sm-4">
                    <div class="text-center">
                        <img src="{{asset('/storage/images/logo/'.'signup.gif')}}" alt="" height="400" width="400" class="img-fluid rounded-circle">
                    </div>
                    ...
                    <form
                        ...
                        <div class="form-group">
                            <label label for="npassword" class="form-label" >Password </label>
                            <input class="au-input au-input--full" type="password" id="password" class="form-control form-control-lg" name="npassword" placeholder="Please enter your home password"/>
                        </div>
                        <div class="form-group">
                            <label label for="confirmpassword" class="form-label" >Confirm Password  </label>
                            <input class="au-input au-input--full" type="text" id="confirmpassword" class="form-control form-control-lg" name="confirmpassword" placeholder="Please enter your home password" value="{{old('newpass') ?? null}}"/>
                        </div>
